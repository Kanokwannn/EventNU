        ...
        <div class="navbar-content">
            ...
            <ul class="navbar-nav navbar-menu-items">
                <li class="navbar-nav-item">
                    <a class="nav-link" href="" data-target="home">หน้าแรก</a>
                </li>
            </ul>
            <div class="nav-right">
                <button class="user-button" id="userButton">
                    <i class="fa-regular fa-user" style="margin-right: 10px;"></i>
                    <a href="login.php" class="text-decoration-none text-dark">ลงชื่อเข้าใช้</a>
                </button>
    ...
    <footer class="home-footer">
        <div class="home-container">
            <div class="home-footer-content">
                <p>&copy; 2025 EventNU. All rights reserved.</p>
                <ul class="home-footer-links">
                    <li><a href="login.php"><i class="fas fa-info-circle"></i> About</a></li>
                    <li><a href="login.php"><i class="fas fa-envelope"></i> Contact</a></li>
                    <li><a href="login.php"><i class="fas fa-file-contract"></i> Terms</a></li>
                    <li><a href="login.php"><i class="fas fa-shield-alt"></i> Privacy</a></li>
                </ul>
            </div>
        </div>
    </footer>
        ...
        function filterEventsByCategory(selectedCategory) {
            ...
            <div class="event-card-content">
                ...
                <div class="event-card-footer">
                    ...
                    <a href="login.php" class="event-detail-btn">Detail</a>
